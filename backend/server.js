...
//     console.log("OLD:", session.title);

//     session.title = title.trim();

//     console.log("NEW:", session.title);
...
//     console.log("SAVED:", updated.title);
...
// // ✅ FIXED: Rename route uses saveSession (not session.save())
// app.put('/api/sessions/:sessionId/title', async (req, res) => {
//   try {
//     const { sessionId } = req.params;
//     const { title } = req.body;
...
//     console.log("MESSAGES AFTER CLEAR:");
